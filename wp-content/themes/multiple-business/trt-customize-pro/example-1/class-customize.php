 ...
 * @access public
 */
final class Multiplebusiness_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Multiplebusiness_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new Multiplebusiness_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
					'title'    => esc_html__( 'Multiple Business Pro', 'multiple-business' ),
					'priority' => 1,
					'pro_text' => esc_html__( 'Buy Pro', 'multiple-business' ),
					'pro_url'  => 'https://keonthemes.com/downloads/multiple-business-pro'
				)
			)
		);
	}
...
Multiplebusiness_Customize::get_instance();
