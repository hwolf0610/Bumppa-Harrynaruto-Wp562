<?php
/**
 * Multiple Business - Theme Info Admin Menu
 * @package Keon Themes
 * @subpackage Admin
 */
if ( ! class_exists( 'multiple_business_Theme_Info' ) ) {
    class multiple_business_Theme_Info{
        ...
        public function prepare_class() {
            ...
            $this->page_title    = isset( $this->config['page_title'] ) ? $this->config['page_title'] : esc_html__('Info','multiple-business'). $this->theme_name;
            $this->menu_title    = isset( $this->config['menu_title'] ) ? $this->config['menu_title'] : esc_html__('Info','multiple-business') . $this->theme_name;
        ...
        public function recommended_actions() {
            ...
            if ( ! empty( $recommended_actions ) ) {
                        ...
                        if ( ! empty( $plugin_slug ) ) {
                            ...
                            switch ( $active['needs'] ) {
                                ...
                                case 'install':
                                    ...
                                    $label = esc_html__( 'Install', 'multiple-business' );
                                    break;

                                case 'activate':
                                    $class = 'activate-now button button-primary';
                                    $label = esc_html__( 'Activate', 'multiple-business' );

                                    break;

                                case 'deactivate':
                                    $class = 'deactivate-now button';
                                    $label = esc_html__( 'Deactivate', 'multiple-business' );
                ...
                if ( $hooray ){
                    echo '<span class="hooray">' . esc_html__( 'Hooray! There are no recommended actions for you right now.', 'multiple-business' ) . '</span>';
                    echo '<a data-action="reset" id="reset" class="reset-all" href="#">'.esc_html__('Show All Recommended Actions','multiple-business').'</a>';
                }
                echo '</div>';
            }
        }
                        ...
                        if( !empty( $screenshot) ){
                            ...
                            if ( ! empty( $title ) ) {
                                ...
                                if ( ! empty( $download_link ) ) {
                                    echo '<a href="' . esc_url( $download_link ) . '" class="button button-primary install right">' . esc_html__( 'Download','multiple-business' ) . '</a>';
                                }
                                if ( ! empty( $preview_link ) ) {
                                    echo '<a class="button button-secondary preview right" target="_blank" href="' . $preview_link . '">' . esc_html__( 'Live Preview','multiple-business' ). '</a>';
                                }
                                echo '</div>';
                                echo '</div>';
                            }
        ...
        public function free_pro() {
            ...
            if ( ! empty( $free_pro ) ) {
                ...
                if ( ! empty( $free_pro ) && is_array( $free_pro ) ) {
                    ...
                    echo '<tr>';
                    echo '<th></th>';
                    echo '<th>' . esc_html__( 'Multiple Business','multiple-business' ) . '</th>';
                    echo '<th>' . esc_html__( 'Multiple Business Pro','multiple-business' ) . '</th>';
                    echo '</tr>';
                    echo '</thead>';
                    echo '<tbody>';
                    ...
                    echo '<td></td>';
                    echo '<td colspan="2"><a href="https://keonthemes.com/downloads/multiple-business-pro/" target="_blank" class="button button-primary button-hero">Multiple Business Pro</a></td>';
                    echo '</tr>';
...
$config = array(
    // Page title.
    'page_title'               => esc_html__( 'Multiple Business Info', 'multiple-business' ),

    // Menu name under Appearance.
    'menu_title'               => esc_html__( 'Multiple Business Info', 'multiple-business' ),

    // Main welcome title
    'info_title'         => sprintf( esc_html__( 'Welcome to %s - ', 'multiple-business' ), 'Multiple Business' ),

    // Main welcome content
    'info_content'       => sprintf( esc_html__( '%s is now installed and ready to use. We hope the following information will help you. If you want to ask any query or just want to say hello, you can always contact us. We hope you enjoy it! ', 'multiple-business' ), '<b>Multiple Business</b>' ),
    ...
    'quick_links'                    => array(
        'theme_url'  => array(
                'text' => __('Theme Details','multiple-business'),
                'url' => 'https://keonthemes.com/downloads/multiple-business/'
        ),
        'demo_url'  => array(
            'text' => __('View Demo','multiple-business'),
            'url' => 'https://keonthemes.com/theme-demo/?id=MzM3NnxtdWx0aXBsZS1idXNpbmVzc3xNdWx0aXBsZSBCdXNpbmVzcw%3D%3D'
        ),
        'pro_url'  => array(
            'text' => __('View Pro Version','multiple-business'),
            'url' => 'https://keonthemes.com/downloads/multiple-business-pro/'
        ),
        'rate_url'  => array(
            'text' => __('Rate This Theme','multiple-business'),
            'url' => 'https://wordpress.org/support/theme/multiple-business/reviews/?filter=5'
        ),
    ),

    'tabs' => array(
        'getting_started'      => __( 'Getting Started', 'multiple-business' ),
        'recommended_plugins'  => __( 'Useful Plugins','multiple-business' ),
        'support'              => __( 'Support', 'multiple-business' ),
        'changelog'            => __( 'Changelog', 'multiple-business' ),
        'faq'                  => __( 'FAQ', 'multiple-business' ),
        'free_pro'             => __( 'Free VS PRO', 'multiple-business' ),
        'demos'                => __( 'Demos', 'multiple-business' ),
    ),

    /*Getting started tab*/
    'getting_started' => array(
        'first' => array(
            'title' => esc_html__( 'Step 1 : Read full documentation','multiple-business' ),
            'desc' => esc_html__( 'Please check our full documentation for detailed information on how to Setup and Use Multiple Business.','multiple-business' ),
            'link_title' => esc_html__( 'Documentation','multiple-business' ),
            'link_url' => 'http://keonthemes.com/doc/multiple-business/',
            'is_button' => false,
            'recommended_actions' => false,
            'is_new_tab' => true
        ),
        'second' => array(
            'title' => esc_html__( 'Step 2 : Go to Customizer','multiple-business' ),
            'desc' => esc_html__( 'All Setting, Theme Options, Frontpage Options, Widgets and Menus are available via Customize screen.','multiple-business' ),
            'link_title' => esc_html__( 'Go to Customizer','multiple-business' ),
    ...
    'faq'      => array(
        'first' => array (
            'title' => esc_html__( 'Does this theme support any plugins?','multiple-business' ),
            'desc' => esc_html__( 'Multiple Business supports WooCommerce, Contact From 7 and MailChimp for WordPress.','multiple-business' ),
            'is_new_tab' => true
        ),
    ),
    // Support content tab.
    'support_content'      => array(
        'first' => array (
            'title' => esc_html__( 'Support Forum','multiple-business' ),
            'desc' => esc_html__( 'Got theme support question or found bug? Best place to ask your query is our dedicated Support forum.','multiple-business' ),
            'button_label' => esc_html__( 'Support Forum','multiple-business' ),
            'button_link' => esc_url( 'https://keonthemes.com/forums/forum/multiple-business/' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'second' => array(
            'title' => esc_html__( 'Documentation','multiple-business' ),
            'desc' => esc_html__( 'Please check our full documentation for detailed information on how to Setup and Use Multiple Business.','multiple-business' ),
            'button_label' => esc_html__( 'Read full documentation','multiple-business' ),
            'button_link' => 'http://keonthemes.com/doc/multiple-business/',
            'is_button' => false,
            'is_new_tab' => true
        ),
        'third' => array(
            'title' => esc_html__( 'Need more features?','multiple-business' ),
            'desc' => esc_html__( 'Upgrade to PRO version for more exciting features and Priority Support.','multiple-business' ),
            'button_label' => esc_html__( 'View Pro Version','multiple-business' ),
            'button_link' => 'https://keonthemes.com/downloads/multiple-business-pro',
            'is_button' => true,
            'is_new_tab' => true
        ),
        'fourth' => array(
            'title' => esc_html__( 'Got sales related question?','multiple-business' ),
            'desc' => esc_html__( "Have any query before purchase, you are more than welcome to ask.",'multiple-business' ),
            'button_label' => esc_html__( 'Pre-sale Question?','multiple-business' ),
            'button_link' => 'mailto:keonthemes@gmail.com',
            'is_button' => false,
            'is_new_tab' => true
        ),
        'fifth' => array(
            'title' => esc_html__( 'Customization Request','multiple-business' ),
            'desc' => esc_html__( 'Needed any customization for the theme, you can request from here.','multiple-business' ),
            'button_label' => esc_html__( 'Customization Request','multiple-business' ),
    ...
    'free_pro' => array(
        array(
            'title'=> __( 'Build with Live Customizer API', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Demo content import', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Fixed Header', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Multiple Header Layout Options', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('6 Layouts','multiple-business'),
        ),
         array(
            'title'=> __( 'Multiple Footer Layout Options', 'multiple-business' ),
            'free' => __('2 Layouts','multiple-business'),
            'pro'  => __('5 Layouts','multiple-business'),
        ),
         array(
            'title'=> __( 'Home Page Templates', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Advanced Theme Options', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
         array(
            'title'=> __( 'Post Layout Options', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
          array(
            'title'=> __( 'Sidebar Position Options', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Unlimited Color Options', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Thin Kfi Font Icons', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Right Sidebar Page template', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Left Sidebar Page template', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Compact View Page template', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Fully Responsive Design', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ), 
        array(
            'title'=> __( 'Translation Ready', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Cross-Browser Compatibility', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'RTL Language Support', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Plugins Support', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page Slider Section', 'multiple-business' ),
            'free' => __('Up to 3 items','multiple-business'),
            'pro'  => __('Unlimited Slider Items','multiple-business'),
        ),
        array(
            'title'=> __( 'Home page Service Section', 'multiple-business' ),
            'free' => __('Up to 3 items','multiple-business'),
            'pro'  => __('Unlimited Service Items','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page About and Carousel Section', 'multiple-business' ),
            'free' => __('Up to 3 Carousel items','multiple-business'),
            'pro'  => __('Video PopUp and Unlimited Carousel items','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page Portfolio Section', 'multiple-business' ),
            'free' => __('Up to 4 items','multiple-business'),
            'pro'  => __('Unlimited Portfolio Items, category nav and column option','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page Testimonial Section', 'multiple-business' ),
            'free' => __('Up to 3 items','multiple-business'),
            'pro'  => __('Unlimited Testimonial Items   ','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page Callback Section', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page Highlight Posts Slider Section', 'multiple-business' ),
            'free' => __('Upto 3 items','multiple-business'),
            'pro'  => __('Unlimited Highlight Posts Items','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page Contact Section', 'multiple-business' ),
            'free' => __('Contact Form only','multiple-business'),
            'pro'  => __('Contact Form, Google Map and Contact detail lists','multiple-business'),
        ),
       array(
            'title'=> __( 'Footer Widgets Section', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page Copyright Section', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('Option to Change text ','multiple-business'),
        ),
       array(
            'title'=> __( 'Disable/Enable option for each Section', 'multiple-business' ),
            'free' => __('yes','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ), 
       array(
            'title'=> __( 'Drag and Drop Re-order/Delete options', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Build with Customizer, Theme Options & Easy Custom Post Types', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Advanced Font Family Options', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( '100+ Google Fonts Options', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Multiple Site Preloader options', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Custom Widgets', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'WPML Plugin Compatibility', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Woocommerce deep Intergration', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Woocommerce Sidebar Position', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('Right, Left and Hide','multiple-business'),
        ),
       array(
            'title'=> __( 'Coming soon / Maintenance Mode Page', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page Process Section', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page App Section', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
       array(
            'title'=> __( 'Home page Team Section', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Home page Achievement Section', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Home page Client Section', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Home page Pricing Table Section', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Home page Woocommerce Product Section', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Contact Page template', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Portfolio / Case Study Page', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
        array(
            'title'=> __( 'Team Single Page', 'multiple-business' ),
            'free' => __('no','multiple-business'),
            'pro'  => __('yes','multiple-business'),
        ),
    ...
    'demos' => array (
        'first' => array(
            'title' => esc_html__( 'Multiple Business ','multiple-business' ),
            'desc' => esc_html__ ( 'Free Theme Demo', 'multiple-business' ),
            'link_title' => esc_html__( 'View Demo','multiple-business' ),
            'link_url' => 'https://keonthemes.com/theme-demo/?id=MzM3NnxtdWx0aXBsZS1idXNpbmVzc3xNdWx0aXBsZSBCdXNpbmVzcw%3D%3D',
            'is_button' => true,
            'recommended_actions' => false,
            'is_new_tab' => true
        ),
        'second'=> array(
            'title' => esc_html__( 'Multiple Business Pro','multiple-business' ),
            'desc' => esc_html__ ( 'Pro Theme Demo', 'multiple-business' ),
            'link_title' => esc_html__( 'View Demo','multiple-business' ),
            'link_url' => 'https://keonthemes.com/theme-demo/?id=MzM4M3xtdWx0aXBsZS1idXNpbmVzcy1wcm98TXVsdGlwbGUgQnVzaW5lc3MgUHJv',
            'is_button' => true,
            'recommended_actions' => false,
            'is_new_tab' => true
        ),
...
return new multiple_business_Theme_Info( $config );
