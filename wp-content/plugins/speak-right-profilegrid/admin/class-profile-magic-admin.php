...
//                endif;
	...
	{       
                add_menu_page(__('SR ProfileGrid','profilegrid-user-profiles-groups-and-communities'),__('SR ProfileGrid','profilegrid-user-profiles-groups-and-communities'),"manage_options","pm_manage_groups",array( $this, 'pm_manage_groups' ),'dashicons-groups');
