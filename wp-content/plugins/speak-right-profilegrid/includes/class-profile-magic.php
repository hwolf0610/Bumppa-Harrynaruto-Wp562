...
class Profile_Magic {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_pm_load_export_fields_dropdown', $plugin_admin, 'pm_load_export_fields_dropdown' );
                ...
                //$this->loader->add_filter('upload_mimes', $plugin_admin, 'pg_custom_upload_mimes');
                $this->loader->add_action('profile_magic_setting_option', $plugin_admin, 'profile_magic_premium_setting_option',1000);
