...
/**
 * @wordpress-plugin
 * Plugin Name:       Speak Right ProfileGroup
 * Plugin URI:        https://speakright.com/
 * Description:       Speak Right ProfileGroup adds user groups and user profiles functionality to your site.
 * Version:           1.0.0
 * Author:            Jin Ming
 * Author URI:        https://speakright.com/
 * Text Domain:       speak-right-profile-group
...
define('PROGRID_PLUGIN_VERSION','4.3.3');
