...
class UR_List_Table_Controller
{
    ...
    public function plugin_menu()
    {
        ...
        $hook = add_menu_page(
            __('Student Reviews', SCR_DOMAIN),
            __('Student Reviews', SCR_DOMAIN) . ' ' . $this->get_review_pending_count_html(),
            'read',
            'scr-reviews-comment',
    ...
    public function plugin_settings_page()
    {
        ...
        $html .= '<h1 class="wp-heading-inline"> ' . __("Student Reviews", SCR_DOMAIN) . '</h1>';
